...
<html lang="en">
  ...
  <body>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active"><a href="eu_r_banking.jsp">TRANSFER<span class="sr-only">(current)</span></a></li>
            <li><a href="eu_r_credit.jsp">CREDIT</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">TRANSFER FUNDS</h1>

          

          <h2 class="sub-header">Enter Payee Details</h2>
        <form>
	...
	<div class="form-group">
      <label for="accNo">From Account:</label>
	</div>
	<div class="form-group">
	<div class="dropdown">
